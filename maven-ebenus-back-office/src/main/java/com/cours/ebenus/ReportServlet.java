...
public class ReportServlet extends HttpServlet {
	...
	private void ajax_getAnalytics(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HashMap<String, Integer> countByIncidentType = incidentDao.countIncidentsByType();
		TreeMap<String, Integer> countByIncidentDate = incidentDao.countIncidentsByDate();

		String jsonCountByIncidentType = gson.toJson(countByIncidentType);
		String jsonCountByIncidentDate = gson.toJson(countByIncidentDate);
		String analyticsData = "["+jsonCountByIncidentType+","+jsonCountByIncidentDate+"]";

		PrintWriter responseWriter = response.getWriter();
        response.setContentType("application/json"); 
        
        responseWriter.print(analyticsData);
