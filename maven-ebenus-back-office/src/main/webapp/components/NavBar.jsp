...
%>
		<nav id="navbar" class="navbar navbar-expand-lg navbar-light bg-light">
			...
			<img src="https://vignette.wikia.nocookie.net/scream/images/7/76/LAPD-Logo.png/revision/latest?cb=20181014120159" style="height: 40px; margin-left: 5px;" alt="LAPD"><i id="adminIcon" title="You are connected as an administrator" class="fas fa-user-lock"></i>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item active">
						<div class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								<i id="managereportsicon" class="fas fa-folder-open"></i>Manage Reports
							</a>
					...
					<c:if test="${user.getRole().getRoleName() == 'Chief'}">
						...
						<li class="nav-item active">
							<a class="nav-link" href="UserServlet?showAllUsers"><i id="manageusersicon" class="fas fa-users"></i>Manage users</a>
						</li>
						
						<li class="nav-item active">
							<a class="nav-link" href="ReportServlet?showAnalytics"><i id="manageusersicon" class="fas fa-chart-pie"></i>Analytics</a>
						</li>
