	...
	<div class="content">
		...
		<div class="container">
			...
			<div style="text-align: center; margin: 50px 0 80px 0;">
				...
				<c:choose>
			        <c:when test="${user.getRole().getRoleName() == 'Chief'}"><i id="createIcon" class="fas fa-chess-king" style="font-size: 120px;"></i></c:when>
			        <c:when test="${user.getRole().getRoleName() == 'Detective'}"><i id="createIcon" class="fas fa-user-secret" style="font-size: 120px;"></i></c:when>
