...
public class Utilisateur {
	...
	public String toString() {
		...
		return "Utilisateur [idUtilisateur=" + getIdUtilisateur() + ", civilite=" + getCivilite() + ", prenom=" + getPrenom()
				+ ", nom=" + getNom() + ", identifiant=" + getIdentifiant() + ", motPasse=" + getMotPasse() + ", dateNaissance="
				+ getDateNaissance() + ", dateCreation=" + getDateCreation() + ", dateModification=" + getDateModification()
				+ ", actif=" + isActif() + ", marquerEffacer=" + isMarquerEffacer() + ", version=" + getVersion() + ", role=" + getRole()
				+ "]";
	}
	...
	public boolean equals(Object other) {
		...
		if (!this.getIdUtilisateur().equals(((Utilisateur)other).getIdUtilisateur())) {
			return false;
		}
